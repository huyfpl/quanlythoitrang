...
//    select ten_sanpham as "tên", anh,soluong as "số lượng"
//    from khachHang kh, sanPham sp, gioHang gh
//    where kh.id_khachHang = gh.id_KhachHang and sp.id_sanPham = gh.id_SanPham and kh.id_khachHang = 4
